...
# acquire current time for log file naming
...
class Molecule:
    def __init__(self, position, key_points, site_states = np.array([0,0,0,0]),Br_postion =  np.array([(0,0),(0,0),(0,0),(0,0)]), orientation=0, status=0, operated=False, operated_time=0):
        ...
        self.Br_postion = Br_postion    # Br atom positions
        ...
        self.status = status  # molecule status, default is 0
        self.operated = operated  # whether operated, default is not operated (False)
