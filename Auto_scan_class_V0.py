...
from keypoint.detect import detect
...
class Mustard_AI_Nanonis(NanonisController):
    def __init__(self, *args, **kwargs):
        ...
        self.Scan_edge = "50n"  # set the initial scan square edge length                           30pix  ==>>  30nm
        self.scan_zoom_V1 = (
        ...
        self.plane_edge = "1.361u"  # plane size repersent the area of the Scanable surface  2um*2um    2000pix  ==>>  2um
        ...
        self.real_scan_factor = (
            0.8  # the real scan area is 80% of the scan square edge length
        )
...
if __name__ == "__main__":
    ...
    nanonis.DQN_init(
        mode="new"
    )  # deflaut mode is 'latest' mode = 'new' : create a new model, mode = 'latest' : load the latest checkpoint
    ...
    while tip_in_boundary(
        ...
        # scan_qulity = 0
        nanonis.create_trajectory(
            scan_qulity
        )  # create the trajectory for tip shaper DQN
